...
# 지정한 위치로 스크롤 내리기
# 모니터 높이 / 해상도(1080) 위치로 스크롤 내리기
# browser.execute_script("window.scrollTo(0, 1080)")  # 1080 은 해상도
# browser.execute_script("window.scrollTo(0, 2080)")

# 화면 가장 아래로 스크롤 내리기
# browser.execute_script("window.scrollTo(0, document.body.scrollHeight)")  # 현재 문서의 총 높이 만큼 스크롤 내림
